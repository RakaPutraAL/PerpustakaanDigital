...
INSERT INTO `buku` VALUES('1', 'malin kundang', 'Mailinda Safitri', 'PT Balai Pustaka (Persero)', '2011', '8', '2026-02-09 09:39:34');
INSERT INTO `buku` VALUES('2', 'Madilog', 'Tan Malaka', 'IRCISOD', '2022', '8', '2026-02-09 09:39:34');
INSERT INTO `buku` VALUES('3', 'harry poter', 'J. K. Rowling', 'Gramedia Pustaka Utama', '2008', '8', '2026-02-09 09:39:34');
INSERT INTO `buku` VALUES('4', 'Si Kancil', 'M.B. Rahimsyah A.R.', 'Lingkar Media', '1990', '15', '2026-02-09 09:39:34');
INSERT INTO `buku` VALUES('5', 'Laskar Pelangi', 'Andrea Hirata', 'Bentang Pustaka', '2005', '8', '2026-02-09 09:39:34');
INSERT INTO `buku` VALUES('6', 'Kimi No Nawa', 'Makoto Sinkai', 'Gramedia', '2016', '6', '2026-02-09 09:39:34');
INSERT INTO `buku` VALUES('7', 'Mie Ayam', 'Bryan Krisna', 'Gramedia', '2022', '7', '2026-02-09 09:39:34');
INSERT INTO `buku` VALUES('8', 'Bumi Manusia', 'Pramoedya Ananta Toer', 'Hasta Mitra', '1980', '5', '2026-02-09 09:39:34');
INSERT INTO `buku` VALUES('9', 'Dunia Sophie', 'Jostein Gaarder', 'Mizan', '1995', '10', '2026-02-09 09:39:34');
INSERT INTO `buku` VALUES('10', 'Bumi', 'Tere Liye', 'Gramedia', '2014', '12', '2026-02-09 09:39:34');
INSERT INTO `buku` VALUES('11', 'Negeri 5 Menara', 'Ahmad Fuadi', 'Gramedia', '2009', '6', '2026-02-09 09:39:34');
INSERT INTO `buku` VALUES('12', 'Sejarah Dunia Lengkap', 'J.M. Roberts', 'Erlangga', '2010', '3', '2026-02-09 09:39:34');
INSERT INTO `buku` VALUES('13', 'Belajar Python Dasar', 'Andi Setiawan', 'Informatika', '2020', '9', '2026-02-09 09:39:34');
INSERT INTO `buku` VALUES('14', 'The Hobbit', 'J.R.R Tolkien', 'Gramedia', '1937', '15', '2026-02-09 09:42:37');
INSERT INTO `buku` VALUES('15', 'transformasi digital', 'Erwin Erwin, Afdhal Chatra P, Asmara Wildani Pasaribu, Nurillah Jamil Achmawati Novel, Sepriano, Abd', 'PTT. Sonpedia Publishing Indonesia', '2023', '5', '2026-02-09 09:43:42');
INSERT INTO `buku` VALUES('16', 'Atlas Dunia', 'National Geographic', 'Gramedia', '2018', '9', '2026-02-09 10:51:58');
...
INSERT INTO `detail_buku` VALUES('1', 'MK-', 'Cerita Malin Kundang berasal dari Sumatra Barat. Mengisahkan tentang seorang anak yang durhaka terhadap ibunya. Cerita ini mengandung nilai-nilai luhur berupa budi pekerti. (Balai Pustaka)', 'Fiksi', 'malin.jpg', '2026-02-09 09:39:34');
...
INSERT INTO `detail_buku` VALUES('3', 'HD-', 'Socioeconomic crisis in Indonesia.', 'Sihir', 'harry.jpg', '2026-02-09 09:39:34');
...
INSERT INTO `detail_buku` VALUES('5', 'LP-', 'Novel tentang perjuangan anak-anak Belitung', 'Fiksi', 'laskar.jpg', '2026-02-09 09:39:34');
INSERT INTO `detail_buku` VALUES('6', 'KNN-', 'Tentang Dua orang gender laki laki perempuan tertukar', 'Fiksi', 'kimi.jpg', '2026-02-09 09:39:34');
INSERT INTO `detail_buku` VALUES('7', 'MAA-', 'Tentang perjuangan makan mie ayam', 'Drama', 'mieayam.jpg', '2026-02-09 09:39:34');
INSERT INTO `detail_buku` VALUES('8', 'BM-', 'Tetralogi Buru Jilid 1', 'Sejarah', 'bumi.jpg', '2026-02-09 09:39:34');
INSERT INTO `detail_buku` VALUES('9', 'DS-', 'Novel pengantar filsafat yang ringan dipahami', 'Filsafat', 'sophie.jpg', '2026-02-09 09:39:34');
INSERT INTO `detail_buku` VALUES('10', 'BM-', 'Petualangan dunia paralel penuh misteri', 'Novel', 'bumii.jpg', '2026-02-09 09:39:34');
INSERT INTO `detail_buku` VALUES('11', 'N5M-', 'Kisah perjuangan santri meraih mimpi', 'Novel', 'negeri.jpg', '2026-02-09 09:39:34');
INSERT INTO `detail_buku` VALUES('12', 'SDL-', 'Ringkasan sejarah dunia dari masa ke masa', 'Sejarah', 'sejarah.jpg', '2026-02-09 09:39:34');
INSERT INTO `detail_buku` VALUES('13', 'PY-', 'Panduan dasar pemrograman Python', 'Teknologi', 'python.png', '2026-02-09 09:39:34');
...
INSERT INTO `detail_buku` VALUES('16', 'AD-', 'Peta dan info negara dunia', 'Geografi', 'atlas.jpg', '2026-02-09 10:51:58');
...
INSERT INTO `transaksi` VALUES('6', '10', 'BM-002', 'leta', '2026-02-05', '2026-02-09', 'kembali', '500');
INSERT INTO `transaksi` VALUES('7', '2', 'MG-001', 'aan', '2026-02-06', '2026-02-10', 'kembali', '500');
...
INSERT INTO `users` VALUES('14', 'eka', '$2y$10$jkbnnmdLvhmxiV3knQiElei4qkqxMUiG4ydiQUV/weORDlnIu1PFO', 'user', '2026-02-10 19:23:01', 'XII RPL 1', 'Cangakan', '2007-12-02', 'pending');
INSERT INTO `users` VALUES('15', 'gilbert', '$2y$10$DYHbCZ.TXjNjOObGEeK1kuGdyxT5DMsPIs8wHgmmM.312tQGSAtIa', 'user', '2026-02-10 19:30:57', 'XII TKR 2', 'Malanggaten', '2004-01-12', 'pending');
